...
class Delivery extends Model
{
    ...
    protected $fillable = [
        ...
        'giaohang_nguoi_nhan_dia_chi','giaohang_so_dien_thoai','giaohang_phuong_thuc_thanh_toan','giaohang_tong_tien_thanh_toan','giaohang_trang_thai','giaohang_ma_don_dat_hang',
        'dondathang_id'
    ];
