                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <div class="text-lg-right mt-3 mt-lg-0">
                                <a href="{{URL::to('/supplier')}}" class="btn btn-success waves-effect waves-light"><i class="ti-arrow-left mr-1"></i>Back</a>
                    ...
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="p-2">
                                        @foreach ($edit_supplier as $key =>$supplier)
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <select name="supplier_status" class="form-control">
                                                        <option value="{{ $supplier->nhacungcap_trang_thai}}">{{ $supplier->nhacungcap_trang_thai?'Show':'Hide' }}</option>
