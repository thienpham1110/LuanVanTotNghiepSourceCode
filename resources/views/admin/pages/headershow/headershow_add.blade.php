                ...
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb page-title">
                            ...
                            <li class="breadcrumb-item active">Header News</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="p-2">
                                        <form action="{{ URL::to('headershow-save') }}" class="form-horizontal" role="form"  method="post" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                                           {{ csrf_field() }}
