                ...
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb page-title">
                            ...
                            <li class="breadcrumb-item active">Header Show</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-box">
                            <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100" cellspacing="0" id="tickets-table">
                                ...
                                <tr>
                                    ...
                                    <th class="font-weight-medium">Link</th>
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{URL::to('/headershow-edit/'.$headershow->id)}}"><i class="mdi mdi-pencil mr-2 text-muted font-18 vertical-middle"></i>Edit</a>
                                                    <a class="dropdown-item" href="{{URL::to('/headershow-delete/'.$headershow->id)}}" onclick="return confirm('You Sure?')"><i class="mdi mdi-delete mr-2 text-muted font-18 vertical-middle"></i>Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
