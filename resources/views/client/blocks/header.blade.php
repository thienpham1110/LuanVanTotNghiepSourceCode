         ...
         <div class="col-lg-6 col-md-6">
             <div class="header_links">
                 <ul>
                     ...
                     <li><a href="index_wishlist.php" title="wishlist">My wishlist</a></li>
                     <li><a href="index_accout.php" title="My account">My account</a></li>
                     <li><a href="index_cart.php" title="My cart">My cart</a></li>
                     <li><a href="index_login.php" title="Login">Login</a></li>
                 </ul>
             </div>
         </div>
    </div>
